...
return [
    ...
    'icons' => [
        ...
        'aliases' => [
            ...
            'my-account-notification' => 'FontAwesome:bell',
            'my-account-warning' => 'FontAwesome:exclamation-triangle',
            ...
            'overdrive-warning' => 'FontAwesome:exclamation-triangle',
            ...
            'profile-card-delete' => 'FontAwesome:delete-o',
            'profile-card-edit' => 'FontAwesome:edit',
            'profile-change-password' => 'FontAwesome:key',
            'profile-delete' => 'FontAwesome:user-times',
            'profile-edit' => 'FontAwesome:edit',
            ...
            'search-delete' => 'FontAwesome:trash-o',
            'search-rss' => 'FontAwesome:rss',
            'search-save' => 'FontAwesome:floppy-o',
            ...
            'tag-add' => 'FontAwesome:plus-circle',
            'tag-remove' => 'FontAwesome:times',
            'tree-context' => 'FontAwesome:sitemap',
            'ui-add' => 'FontAwesome:plus-circle',
            'ui-back' => 'FontAwesome:arrow-right',
            ...
            'user-hold' => 'FontAwesome:flag',
            'user-ill-request' => 'FontAwesome:exchange',
            'user-list' => 'FontAwesome:star',
            'user-list-add' => 'FontAwesome:bookmark-o',
            'user-list-delete' => 'FontAwesome:times',
            'user-list-edit' => 'FontAwesome:edit',
            'user-list-entry-edit' => 'FontAwesome:edit',
            'user-list-remove' => 'FontAwesome:times',
            'user-list-save' => 'FontAwesome:bookmark-o',
