      ...
      if (typeof(result.full_status) != 'undefined'
        ...
        for (var x = 0; x < result.locationList.length; x++) {
          ...
          if (result.locationList[x].availability) {
            locationListHTML += '<i class="fa fa-ok label success" aria-hidden="true"></i> <span class="label success">'
            ...
            locationListHTML += '<i class="fa fa-remove label error" aria-hidden="true"></i> <span class="label error"">'
              + result.locationList[x].location + '</span> ';
          }
