...
function registerAjaxCommentRecord() {
  ...
  $('form.comment-form').unbind('submit').submit(function commentFormSubmit() {
    ...
    .done(function addCommentDone(/*response, textStatus*/) {
      ...
      if (!$tab.length) {
      // FNDTN uses .content instead of .tab-pane
        $tab = $form.closest('.content');
      }
...
function getNewRecordTab(tabid) {
  // FNDTN uses .content instead of .tab-pane
  return $('<div class="content ' + tabid + '-tab"><i class="fa fa-spinner fa-spin" aria-hidden="true"></i> ' + VuFind.translate('loading') + '...</div>');
}
